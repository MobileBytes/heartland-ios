...
@implementation HpsPaxGiftResponse

- (id) initWithBuffer:(NSData*)buffer{
    if((self = [super initWithMessageID:T07_RSP_DO_GIFT andBuffer:buffer]))
    {
        [self parseResponse];
    }
    return self;
...
- (HpsBinaryDataScanner*) parseResponse{
    ...
    if ([self.deviceResponseCode isEqualToString:@"000000"] || [self.deviceResponseCode isEqualToString:@"000002"]) {
...
- (void) mapResponse{
    ...
    @try {
        ...
        NSLog(@"Error on mapResponse GIFT RESPONSE");
